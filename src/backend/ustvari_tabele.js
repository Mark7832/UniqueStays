...
async function napolniBazo() {
    ...
    // PRENOCISCE
        ...
        const Prenocisce = [
            ...
            { naziv: 'Cliffside Cave Suite', datum_dodano: '2025-03-05', tip_prenocisca: 'Jama', opis_prenocisca: 'Luksuzna soba vklesana v skalno steno nad Egejskim morjem na Santoriniju. Zasebni bazen na terasi z neposrednim pogledom na kaldera in rdeče skale.', cena_na_noc: 520, koordinate: '36.4618,25.3764', naslov: 'Oia, Santorini, Grčija', sezona: 'Pomlad / Poletje', max_gostov: 2, stevilo_sob: 1, wifi: true, parking: false, razgled: true, zajtrk: true, bazen: true, tagi: JSON.stringify([{ naziv: '🏊 Zasebni infinity bazen' },{ naziv: '🌅 Najlepši sončni zahod na svetu' },{ naziv: '⛵ Izlet z jadrnico' },{ naziv: '🍷 Degustacija grškega vina' },{ naziv: '🐬 Plavanje z delfini' }]), TK_uporabnik: 1 },
            { naziv: 'Scottish Highland Castle', datum_dodano: '2025-03-18', tip_prenocisca: 'Grad', opis_prenocisca: 'Prenovljeni škotski grad iz 14. stoletja sredi divje narave Highlands. Kamini v vsaki sobi, zasebno jezero za ribolov in whisky degustacija v grajski kleti.', cena_na_noc: 480, koordinate: '57.4907,-4.2026', naslov: 'Inverness, Škotska', sezona: 'Celo leto', max_gostov: 10, stevilo_sob: 5, wifi: true, parking: true, razgled: true, zajtrk: true, ljubljencki: true, tagi: JSON.stringify([{ naziv: '🏰 Grad iz 14. stoletja' },{ naziv: '🎣 Zasebno jezero za ribolov' },{ naziv: '🥃 Whisky degustacija' },{ naziv: '🦌 Opazovanje jelenov' },{ naziv: '🔥 Kamin v vsaki sobi' },{ naziv: '👻 Grajska legenda o duhu' }]), TK_uporabnik: 1 },
            { naziv: 'Floating Amazon Lodge', datum_dodano: '2025-04-02', tip_prenocisca: 'Plavajoča hiša', opis_prenocisca: 'Plavajoča lesena hiša na reki Amazonas sredi neokrnjene džungle. Opazujte pirane, kajmane in rožnate delfine neposredno s terase.', cena_na_noc: 310, koordinate: '-3.4653,-62.2159', naslov: 'Amazonas, Brazilija', sezona: 'Poletje / Jesen', max_gostov: 4, stevilo_sob: 2, razgled: true, zajtrk: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🐊 Opazovanje kajmanov' },{ naziv: '🐬 Opazovanje rožnatih delfinov' },{ naziv: '🌿 Vodeni pohod po džungli' },{ naziv: '🎣 Ribolov piranj' },{ naziv: '🌙 Nočni zvoki džungle' },{ naziv: '🦜 Opazovanje papagajev' }]), TK_uporabnik: 1 },
            ...
            { naziv: 'Floating Overwater Bungalow', datum_dodano: '2025-06-15', tip_prenocisca: 'Bungalov nad vodo', opis_prenocisca: 'Klasični bungalov na koleh nad turkiznim morjem na Tahitiju z direktnim dostopom do morja skozi steklena tla in zasebni pomol.', cena_na_noc: 445, koordinate: '-17.6509,-149.4260', naslov: 'Bora Bora, Francoska Polinezija', sezona: 'Celo leto', max_gostov: 2, stevilo_sob: 1, wifi: true, razgled: true, zajtrk: true, tagi: JSON.stringify([{ naziv: '🪸 Steklena tla nad morjem' },{ naziv: '⛵ Zasebni pomol' },{ naziv: '🤿 Snorklanje direktno iz sobe' },{ naziv: '🧖 Polinezijska masaža' },{ naziv: '🐠 Hranjenje rib s terase' },{ naziv: '🌅 Sončni zahod nad laguno' }]), TK_uporabnik: 6 },
            ...
            { naziv: 'Salt Flat Mirrored Cabin', datum_dodano: '2025-07-01', tip_prenocisca: 'Ogledalna kabina', opis_prenocisca: 'Kabina z ogledalno zunanjostjo sredi bolivijskih slanih ravnin Salar de Uyuni. Ob deževni sezoni postane tla popolno ogledalo neba, kar ustvari mistični efekt neskončnosti.', cena_na_noc: 198, koordinate: '-20.1338,-67.4891', naslov: 'Uyuni, Bolivija', sezona: 'Zima / Pomlad', max_gostov: 2, stevilo_sob: 1, parking: true, razgled: true, zajtrk: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🪞 Ogledalo neba' },{ naziv: '🦩 Flamingoti v naravi' },{ naziv: '🌌 Nočno fotografiranje zvezd' },{ naziv: '🚗 Tura po slanih ravninah' },{ naziv: '🧂 Hiša iz soli' }]), TK_uporabnik: 6 },
            ...
            { naziv: 'Hobbit House Shire', datum_dodano: '2025-04-15', tip_prenocisca: 'Zemeljska hiška', opis_prenocisca: 'Resnična hiška hobita vkopana v hrib na Novi Zelandiji, blizu posnetkov filma Gospodar prstanov. Okrogla vrata, nizki stropi in čarobno vzdušje Shire-ja.', cena_na_noc: 185, koordinate: '-37.8723,175.6828', naslov: 'Matamata, Nova Zelandija', sezona: 'Celo leto', max_gostov: 2, stevilo_sob: 1, wifi: true, parking: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '💍 Vzdušje Gospodarja prstanov' },{ naziv: '🌄 Zeleni hribi Shire-ja' },{ naziv: '🎬 Ogled filmskih lokacij' },{ naziv: '🍺 Lokalno craft pivo' },{ naziv: '🌾 Jutranji sprehod po poljih' }]), TK_uporabnik: 9 },
            { naziv: 'Volcanic Lava Cabin', datum_dodano: '2025-01-15', tip_prenocisca: 'Kabina', opis_prenocisca: 'Moderna kabina na robu vulkanskega polja na Islandiji, z direktnim pogledom na aktivne lavljine tokove in gejzirje. Ogrevanje iz geotermalnih virov.', cena_na_noc: 275, koordinate: '63.9179,-22.0609', naslov: 'Grindavík, Islandija', sezona: 'Celo leto', max_gostov: 2, stevilo_sob: 1, wifi: true, parking: true, razgled: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🌋 Pogled na lavo' },{ naziv: '♨️ Geotermalno ogrevanje' },{ naziv: '🌊 Bližina Blue Lagoon' },{ naziv: '📸 Fotografiranje vulkana' }]), TK_uporabnik: 10 },
            { naziv: 'Arctic Glass Igloo', datum_dodano: '2025-02-01', tip_prenocisca: 'Iglu', opis_prenocisca: 'Stekleni iglu sredi finskega gozda, kjer ležite v topli postelji in opazujete severni sij skozi stekleni strop. Zimska pravljica za prave romantike.', cena_na_noc: 390, koordinate: '68.9222,27.0242', naslov: 'Saariselkä, Finska', sezona: 'Jesen / Zima', max_gostov: 3, stevilo_sob: 1, wifi: true, parking: true, razgled: true, zajtrk: true, tagi: JSON.stringify([{ naziv: '❄️ Stekleni strop' },{ naziv: '🌠 Severni sij' },{ naziv: '🦌 Izlet s severnimi jeleni' },{ naziv: '🎿 Smučarski begi' },{ naziv: '🛁 Zunanja kad v snegu' }]), TK_uporabnik: 11 },
            { naziv: 'Desert Dome Retreat', datum_dodano: '2025-02-20', tip_prenocisca: 'Glamping', opis_prenocisca: 'Luksuzna geodetska kupola sredi maroškega Sahare, z zvezdnatim nebom nad vami in tišino puščave okoli vas. Vključen kamelji izlet ob sončnem zahodu.', cena_na_noc: 240, koordinate: '31.0461,-4.0083', naslov: 'Merzouga, Maroko', sezona: 'Jesen / Pomlad', max_gostov: 2, stevilo_sob: 1, wifi: false, parking: true, razgled: true, zajtrk: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🐪 Kamelji izlet' },{ naziv: '🌅 Sončni zahod v Sahari' },{ naziv: '🌌 Opazovanje zvezd' },{ naziv: '🥁 Berbarska glasba ob ognju' },{ naziv: '🏜️ Peščene dine' }]), TK_uporabnik: 12 },
            { naziv: 'Bamboo Zen Treehouse', datum_dodano: '2025-05-01', tip_prenocisca: 'Drevesna hišica', opis_prenocisca: 'Minimalistična bambusova hišica med riževimi polji na Baliju, z neskončnim pogledom na terase in tropski gozd. Vsakodnevna joga in meditacija vključena.', cena_na_noc: 165, koordinate: '-8.4095,115.1889', naslov: 'Ubud, Bali, Indonezija', sezona: 'Poletje / Jesen', max_gostov: 2, stevilo_sob: 1, wifi: true, parking: true, razgled: true, zajtrk: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🧘 Joga in meditacija' },{ naziv: '🌾 Pogled na riževa polja' },{ naziv: '🛕 Obiski templjev' },{ naziv: '🌺 Balinezijska masaža' },{ naziv: '🍚 Kuharski tečaj lokalne kulinarike' }]), TK_uporabnik: 12 },
            { naziv: 'Lighthouse Keeper Cottage', datum_dodano: '2025-05-18', tip_prenocisca: 'Svetilnik', opis_prenocisca: 'Prenovljeni svetilnik na skalni pečini nad Atlantskim oceanom na irski obali. Pogled na divje valove, kite in tjulnje direktno iz okna spalnice.', cena_na_noc: 220, koordinate: '52.1606,-10.4678', naslov: 'Dingle, Irska', sezona: 'Pomlad / Poletje', max_gostov: 8, stevilo_sob: 4, wifi: true, parking: true, razgled: true, ljubljencki: true, tagi: JSON.stringify([{ naziv: '🌊 Pogled na Atlantik' },{ naziv: '🐋 Opazovanje kitov' },{ naziv: '🦭 Opazovanje tjulnjev' },{ naziv: '🍺 Irski pub v bližini' },{ naziv: '🎵 Tradicionalna irska glasba' },{ naziv: '🧗 Plezanje po pečinah' }]), TK_uporabnik: 14 },
            { naziv: 'Underground Lava Tube Hotel', datum_dodano: '2026-06-01', tip_prenocisca: 'Podzemna soba', opis_prenocisca: 'Edinstven hotel v naravni lavini cevi na Havajih. Spalnica je vklesana v 500 let staro vulkansko cev z naravno temperaturo 22°C skozi vse leto.', cena_na_noc: 295, koordinate: '19.8968,-155.5828', naslov: 'Hilo, Havaji, ZDA', sezona: 'Celo leto', max_gostov: 2, stevilo_sob: 1, parking: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🌋 Naravna vulkanska cev' },{ naziv: '🏄 Uče ure surfanja' },{ naziv: '🐢 Opazovanje morskih želv' },{ naziv: '🌺 Havajska hula delavnica' },{ naziv: '🤿 Snorklanje v čistem morju' }]), TK_uporabnik: 15 },
        ];
    ...
    // REZERVACIJA
        ...
        const Rezervacija = [
            ...
            { datum_od: '2025-01-05', datum_do: '2025-01-10', datum_rezervacije: '2024-12-10', rezervirano: true, TK_uporabnik: 3, TK_prenocisce: 1 },
            { datum_od: '2025-01-15', datum_do: '2025-01-20', datum_rezervacije: '2024-12-20', rezervirano: true, TK_uporabnik: 4, TK_prenocisce: 6 },
            { datum_od: '2025-02-01', datum_do: '2025-02-06', datum_rezervacije: '2025-01-05', rezervirano: true, TK_uporabnik: 5, TK_prenocisce: 3 },
            { datum_od: '2025-02-14', datum_do: '2025-02-17', datum_rezervacije: '2025-01-20', rezervirano: true, TK_uporabnik: 6, TK_prenocisce: 2 },
            { datum_od: '2025-03-01', datum_do: '2025-03-07', datum_rezervacije: '2025-02-01', rezervirano: true, TK_uporabnik: 7, TK_prenocisce: 5 },
            { datum_od: '2025-03-15', datum_do: '2025-03-20', datum_rezervacije: '2025-02-15', rezervirano: false, TK_uporabnik: 8, TK_prenocisce: 9 },
            { datum_od: '2025-04-01', datum_do: '2025-04-05', datum_rezervacije: '2025-03-01', rezervirano: true, TK_uporabnik: 9, TK_prenocisce: 4 },
            { datum_od: '2025-04-10', datum_do: '2025-04-15', datum_rezervacije: '2025-03-10', rezervirano: true, TK_uporabnik: 10, TK_prenocisce: 7 },
            { datum_od: '2025-04-20', datum_do: '2025-04-26', datum_rezervacije: '2025-03-20', rezervirano: true, TK_uporabnik: 11, TK_prenocisce: 1 },
            { datum_od: '2025-05-05', datum_do: '2025-05-10', datum_rezervacije: '2025-04-05', rezervirano: true, TK_uporabnik: 12, TK_prenocisce: 8 },
            { datum_od: '2025-05-15', datum_do: '2025-05-20', datum_rezervacije: '2025-04-20', rezervirano: true,  TK_uporabnik: 13, TK_prenocisce: 10 },
            { datum_od: '2025-06-01', datum_do: '2025-06-06', datum_rezervacije: '2025-05-01', rezervirano: true,  TK_uporabnik: 14, TK_prenocisce: 11 },
            { datum_od: '2025-06-10', datum_do: '2025-06-15', datum_rezervacije: '2025-05-10', rezervirano: false, TK_uporabnik: 15, TK_prenocisce: 12 },
            { datum_od: '2025-07-01', datum_do: '2025-07-07', datum_rezervacije: '2025-06-01', rezervirano: true,  TK_uporabnik: 1,  TK_prenocisce: 13 },
            { datum_od: '2025-07-15', datum_do: '2025-07-20', datum_rezervacije: '2025-06-15', rezervirano: true,  TK_uporabnik: 2,  TK_prenocisce: 14 },
            { datum_od: '2025-08-01', datum_do: '2025-08-05', datum_rezervacije: '2025-07-05', rezervirano: true,  TK_uporabnik: 3,  TK_prenocisce: 15 },
            { datum_od: '2025-08-15', datum_do: '2025-08-20', datum_rezervacije: '2025-07-20', rezervirano: false, TK_uporabnik: 4,  TK_prenocisce: 16 },
            { datum_od: '2025-09-01', datum_do: '2025-09-06', datum_rezervacije: '2025-08-01', rezervirano: true,  TK_uporabnik: 5,  TK_prenocisce: 17 },
            { datum_od: '2025-09-15', datum_do: '2025-09-20', datum_rezervacije: '2025-08-15', rezervirano: true,  TK_uporabnik: 6,  TK_prenocisce: 18 },
            { datum_od: '2025-10-01', datum_do: '2025-10-07', datum_rezervacije: '2025-09-01', rezervirano: true,  TK_uporabnik: 7,  TK_prenocisce: 19 },
            { datum_od: '2025-10-15', datum_do: '2025-10-20', datum_rezervacije: '2025-09-15', rezervirano: true,  TK_uporabnik: 8,  TK_prenocisce: 20 },
            { datum_od: '2025-11-01', datum_do: '2025-11-06', datum_rezervacije: '2025-10-01', rezervirano: false, TK_uporabnik: 9,  TK_prenocisce: 2 },
            { datum_od: '2025-11-15', datum_do: '2025-11-20', datum_rezervacije: '2025-10-15', rezervirano: true,  TK_uporabnik: 10, TK_prenocisce: 3 },
            { datum_od: '2025-12-01', datum_do: '2025-12-07', datum_rezervacije: '2025-11-01', rezervirano: true,  TK_uporabnik: 11, TK_prenocisce: 6 },
            { datum_od: '2025-12-20', datum_do: '2025-12-27', datum_rezervacije: '2025-11-20', rezervirano: true,  TK_uporabnik: 12, TK_prenocisce: 17 },
            { datum_od: '2026-01-05', datum_do: '2026-01-10', datum_rezervacije: '2025-12-01', rezervirano: true,  TK_uporabnik: 13, TK_prenocisce: 1 },
            { datum_od: '2026-01-15', datum_do: '2026-01-20', datum_rezervacije: '2025-12-15', rezervirano: true,  TK_uporabnik: 14, TK_prenocisce: 7 },
            { datum_od: '2026-02-01', datum_do: '2026-02-06', datum_rezervacije: '2026-01-05', rezervirano: true,  TK_uporabnik: 15, TK_prenocisce: 9 },
            { datum_od: '2026-02-14', datum_do: '2026-02-17', datum_rezervacije: '2026-01-20', rezervirano: true,  TK_uporabnik: 1,  TK_prenocisce: 17 },
            { datum_od: '2026-03-01', datum_do: '2026-03-07', datum_rezervacije: '2026-02-01', rezervirano: false, TK_uporabnik: 2,  TK_prenocisce: 11 },
            { datum_od: '2026-04-10', datum_do: '2026-04-15', datum_rezervacije: '2026-03-10', rezervirano: true,  TK_uporabnik: 3,  TK_prenocisce: 18 },
            { datum_od: '2026-05-01', datum_do: '2026-05-06', datum_rezervacije: '2026-04-01', rezervirano: true,  TK_uporabnik: 4,  TK_prenocisce: 19 },
            { datum_od: '2026-06-10', datum_do: '2026-06-15', datum_rezervacije: '2026-05-10', rezervirano: true,  TK_uporabnik: 5,  TK_prenocisce: 20 },
            { datum_od: '2026-07-01', datum_do: '2026-07-06', datum_rezervacije: '2026-06-01', rezervirano: true,  TK_uporabnik: 6,  TK_prenocisce: 4 },
            { datum_od: '2026-07-15', datum_do: '2026-07-20', datum_rezervacije: '2026-06-15', rezervirano: false, TK_uporabnik: 7,  TK_prenocisce: 15 },
            { datum_od: '2026-08-01', datum_do: '2026-08-07', datum_rezervacije: '2026-07-01', rezervirano: true,  TK_uporabnik: 8,  TK_prenocisce: 5 },
            { datum_od: '2026-09-01', datum_do: '2026-09-05', datum_rezervacije: '2026-08-01', rezervirano: true,  TK_uporabnik: 9,  TK_prenocisce: 13 },
            { datum_od: '2026-10-01', datum_do: '2026-10-06', datum_rezervacije: '2026-09-01', rezervirano: true,  TK_uporabnik: 10, TK_prenocisce: 16 },
            { datum_od: '2026-11-01', datum_do: '2026-11-06', datum_rezervacije: '2026-10-01', rezervirano: true,  TK_uporabnik: 11, TK_prenocisce: 17 },
            { datum_od: '2026-12-10', datum_do: '2026-12-16', datum_rezervacije: '2026-11-10', rezervirano: false, TK_uporabnik: 12, TK_prenocisce: 6 },
        ];
    ...
    // DOZIVETJE
        ...
        const Dozivetje = [
            ...
            { naziv: 'Inštruktor smučanja', opis: 'Privatne ure smučanja z izkušenim inštruktorjem za vse nivoje.', doplacilo: 79.99, TK_uporabnik: 1, TK_prenocisce: 1 },
            ...
            { naziv: 'Whisky degustacija', opis: 'Degustacija vrhunskih škotskih whiskyjev v avtentični grajski kleti.', doplacilo: 39.99, TK_uporabnik: 1, TK_prenocisce: 3 },
            ...
            { naziv: 'Viteška večerja', opis: 'Večerja ob svečah v grajski dvorani z viteškim menijem in srednjeveško glasbo.', doplacilo: 52.99,  TK_uporabnik: 2, TK_prenocisce: 5 },
            ...
            { naziv: 'Večerja pod zvezdami', opis: 'Romantična islandska večerja postrežena neposredno ob stekleni kupoli.', doplacilo: 39.99, TK_uporabnik: 3, TK_prenocisce: 6 },
            ...
            { naziv: 'Večer ob lanternah', opis: 'Posebna večerja v jami ob lanternah in tradicionalni turški glasbi.', doplacilo: 36.99, TK_uporabnik: 4, TK_prenocisce: 7 },
            ...
            { naziv: 'Večer čarobnih lantern', opis: 'Nočni sprehod skozi osvetljen gozd z lebdečimi lanternami.', doplacilo: 22.99, TK_uporabnik: 9, TK_prenocisce: 14},
            ...
            { naziv: 'Surfanje na Havajih', opis: 'Osnove surfanja z licenciranim inštruktorjem na mirni plaži.', doplacilo: 69.99, TK_uporabnik: 15, TK_prenocisce: 21 },
    ...
    // SLIKE
        ...
        const Slika = [
            ...
            { slika: fs.readFileSync(path.join(__dirname, '../frontend/images/santorini.jpg')), ime_slike: 'santorini.jpg', cover: true, TK_prenocisce: 2 },
            ...
            { slika: fs.readFileSync(path.join(__dirname, '../frontend/images/bolivija.jpg')), ime_slike: 'bolivija.jpg', cover: true, TK_prenocisce: 11 },
            ...
            { slika: fs.readFileSync(path.join(__dirname, './frontend/images/jeleni.jpg')), ime_slike: 'jeleni.jpg', cover: true, TK_dozivetje: 7 },
        ...
        console.log('Slika uspesno dodana.');
    ...
    // SPOROCILA
        ...
        const Sporocila = [
            ...
            { vprasanje: 'Ali je savna vključena v ceno?', odgovor: 'Da, zasebna savna je na voljo vsak večer brezplačno.', datum_sporocila: '2024-10-10', TK_uporabnik: 1, TK_prenocisce: 1 },
            ...
            { vprasanje: 'Koliko je oddaljeno smučišče?', odgovor: 'Približno 10 minut.', datum_sporocila: '2025-05-22', TK_uporabnik: 2, TK_prenocisce: 12 },
    ...
    // KOMENTAR
        ...
        const Komentar = [
            ...
            { komentar: 'Severni sij iz igluja je bil magičen.', datum_komentar: '2024-07-15', ocena_splosna: 5, ocena_udobje: 4, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 2, ocena_dozivetje: 5, TK_uporabnik: 2, TK_prenocisce: 3 },
            ...
            { komentar: 'Predjamski grad kot iz pravljice.', datum_komentar: '2024-08-20', ocena_splosna: 5, ocena_udobje: 4, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 3, ocena_dozivetje: 4, TK_uporabnik: 2, TK_prenocisce: 5 },
            ...
            { komentar: 'Romantičnejšega mesta ni na svetu. Kupola pod severnim sijem!', datum_komentar: '2024-09-01', ocena_splosna: 5, ocena_udobje: 5, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 3, ocena_dozivetje: 5, TK_uporabnik: 4, TK_prenocisce: 6 },
            ...
            { datum_komentar: '2025-04-05', ocena_splosna: 5, ocena_udobje: 5, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 2, ocena_dozivetje: 5, TK_uporabnik: 6, TK_prenocisce: 2 },
            ...
            { komentar: 'Ribolov na zasebnem jezeru je bil popolnoma sproščujoč. Odlična izkušnja.', datum_komentar: '2025-11-20', ocena_splosna: 5, ocena_udobje: 4, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 3, ocena_dozivetje: 5, TK_uporabnik: 10, TK_prenocisce: 3 },
            ...
            { datum_komentar: '2024-09-01', ocena_splosna: 5, ocena_udobje: 5, ocena_unikatnost: 5, ocena_lokacija: 5, ocena_cenovna_ugodnost: 3, ocena_dozivetje: 5, TK_uporabnik: 4, TK_prenocisce: 6 },
