...
async function napolniBazo() {
    try {
        ...
        const Slika = [
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/ana.jpg')), ime_slike: 'ana.jpg', cover: true, TK_uporabnik: 4 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/gregor.jpg')), ime_slike: 'gregor.jpg', cover: true, TK_uporabnik: 14 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/joze.jpg')), ime_slike: 'joze.jpg', cover: true, TK_uporabnik: 1 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/luka.jpg')), ime_slike: 'luka.jpg', cover: true, TK_uporabnik: 3 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/marko.jpg')), ime_slike: 'marko.jpg', cover: true, TK_uporabnik: 6 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/nina.jpg')), ime_slike: 'nina.jpg', cover: true, TK_uporabnik: 7 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/tina.jpg')), ime_slike: 'tina.jpg', cover: true, TK_uporabnik: 5 },
            { slika: fs.readFileSync(path.join(__dirname, 'frontend/images/urh.jpg')), ime_slike: 'urh.jpg', cover: true, TK_uporabnik: 10 },
