...
async function napolniBazo() {
    ...
    // PRENOCISCE
        ...
        const Prenocisce = [
            ...
            { naziv: 'Salt Flat Mirrored Cabin', datum_dodano: '2025-07-01', tip_prenocisca: 'Hiška sredi solin', opis_prenocisca: 'Kabina z ogledalno zunanjostjo sredi bolivijskih slanih ravnin Salar de Uyuni. Ob deževni sezoni postane tla popolno ogledalo neba, kar ustvari mistični efekt neskončnosti.', cena_na_noc: 198, koordinate: '-20.1338,-67.4891', naslov: 'Uyuni, Bolivija', sezona: 'Zima / Pomlad', max_gostov: 2, stevilo_sob: 1, parking: true, razgled: true, zajtrk: true, trajnostno: true, tagi: JSON.stringify([{ naziv: '🪞 Ogledalo neba' },{ naziv: '🦩 Flamingoti v naravi' },{ naziv: '🌌 Nočno fotografiranje zvezd' },{ naziv: '🚗 Tura po slanih ravninah' },{ naziv: '🧂 Hiša iz soli' }]), TK_uporabnik: 6 },
