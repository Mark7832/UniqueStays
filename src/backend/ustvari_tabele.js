...
async function napolniBazo() {
    ...
    // KOMENTAR
        ...
        const Komentar = [
            ...
            { komentar: 'Soba je bila čista in moderna, lokacija pa zelo mirna.', datum_komentar: '2024-07-12', ocena_splosna: 4, ocena_udobje: 5, ocena_unikatnost: 4, ocena_lokacija: 4, ocena_cenovna_ugodnost: 5, ocena_dozivetje: 4, TK_uporabnik: 2, TK_prenocisce: 2 },
