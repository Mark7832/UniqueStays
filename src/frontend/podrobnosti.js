        ...
        function inicializirajZemljevid(koordinate) {
            console.log('🗺️ Inicializacija zemljevida z koordinatami:', koordinate);
            
            // Parsiranje koordinat (format: "latitude,longitude")
            ...
            // Dodaj OpenStreetMap plasti
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
                maxZoom: 19
            }).addTo(map);
            
            // Ustvari custom ikono za prenočišče
            ...
            console.log('✅ Zemljevid uspešno inicializiran');
        }
        ...
        function prikaziMojoLokacijo() {
            ...
            console.log('📍 Pridobivam vašo lokacijo...');
            ...
            navigator.geolocation.getCurrentPosition(
                function(position) {
                    ...
                    console.log('✅ Vaša lokacija:', userLat, userLng);
                    
                    // Odstrani stari marker in routing
                    if (userMarker) {
                    ...
                    routingControl = L.Routing.control({
                        ...
                        createMarker: function() { return null; }, // Ne dodajaj dodatnih markerjev
                        language: 'sl'
                    }).addTo(map);
                    
                    // Prilagodi pogled za prikaz celotne poti
                    ...
                    console.log('✅ Pot uspešno izrisana!');
                },
                function(error) {
        ...
        // OBSTOJEČE FUNKCIJE IZ ORIGINALNE DATOTEKE
        
        const API_URL = 'http://localhost:3000/api';
        
        async function naloziPodatke() {
            console.log('🚀 Začenjam nalaganje podatkov...');
            
            const urlParams = new URLSearchParams(window.location.search);
            const prenocisceId = urlParams.get('id') || 2;
            
            console.log('🔍 ID prenočišča:', prenocisceId);
            console.log('📍 Celoten URL:', window.location.href);
            
            try {
                console.log(`📡 Pošiljam zahtevo na ${API_URL}/prenocisce/${prenocisceId}...`);
        ...
        function prikaziPodatke(data) {
            console.log('📊 Prikaz podatkov:', data);
            
            const { prenocisce, slike, dozivetja, komentarji, povprecnaOcena } = data;
            
            console.log('📝 Prenočišče:', prenocisce);
            console.log('🖼️ Slike:', slike);
            
            // Preveri če podatki obstajajo
            if (!prenocisce) {
                console.error('NAPAKA: Prenočišče ne obstaja v podatkih!');
                return;
            }
            
            // Prikaži cover sliko kot hero background
        ...
        // Funkcija za prikaz hero background slike
        function prikaziHeroSliko(slike) {
            console.log('🖼️ Prikazujem hero sliko...', slike);
            ...
            console.log('✅ Cover slika najdena:', coverSlika.ime_slike);
            console.log('📊 Cover slika podatki:', coverSlika);
            ...
            if (coverSlika.slika && typeof coverSlika.slika === 'string') {
                ...
                console.log('✅ Hero background nastavljen iz API');
            } else {
        ...
        function prikaziDozivetja(dozivetja) {
            console.log('🎭 DOŽIVETJA:', dozivetja);
            ...
            if (!dozivetja || dozivetja.length === 0) {
                container.innerHTML = '<p class="text-slate-600 col-span-full text-center">Trenutno ni dodatnih doživetij.</p>';
                return;
            }
        ...
        console.log('🎬 Dodajam event listener...');
        window.addEventListener('DOMContentLoaded', function() {
            console.log('📄 DOM je naložen, začenjam nalaganje podatkov...');
            naloziPodatke();
        });
        
        console.log('✅ Skripta naložena!');